...
define( "RECIPIENT_NAME", "Monique D. Scott & Associates" );
define( "RECIPIENT_EMAIL", "moniquescottlaw@hotmail.com" );
define( "RECIPIENT_EMAIL_2", "moniquedscottandassociates@gmail.com" );
...
if ( $name && $senderEmail && $message ) {
  $recipient = RECIPIENT_NAME . " <" . RECIPIENT_EMAIL . ">, " . RECIPIENT_NAME . " <" . RECIPIENT_EMAIL_2 . ">";
